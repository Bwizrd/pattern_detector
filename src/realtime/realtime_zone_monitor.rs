...
use crate::cache::minimal_zone_cache::{MinimalZoneCache, TradeNotification};

use crate::trading::trade_decision_engine::{TradeDecisionEngine, ValidatedTradeSignal};
...
impl NewRealTimeZoneMonitor {
  ...
  pub async fn update_price_with_cache_notifications(
    ...
    static GLOBAL_TRADE_LOGGER: LazyLock<
        std::sync::Mutex<
            Option<Arc<tokio::sync::Mutex<crate::trading::trade_event_logger::TradeEventLogger>>>,
        >,
